...
./modeAssign ./B5_topicAssignments_OurModel_estAll.txt ./B5_topicAssignments_ModeAssignment_estAll.txt
./modeAssign ./B5_parentAssignments_OurModel_estAll.txt ./B5_parentAssignments_ModeAssignment_estAll.txt
