...
wuvOutFile = "wuvEstFile_withOutPrior.txt"
...
def getLevelInfo():
	topParentsFile = open("../top100CandParents_sample_events_1L_time_16.txt")
...
def estimateWuv():
	...
	for gid in groupNumeSum:
		...
		if(groupSourceDenomSum[gid] > 0):
			wuvVal = (groupNumeSum[gid])*1.0 / (groupSourceDenomSum[gid])
