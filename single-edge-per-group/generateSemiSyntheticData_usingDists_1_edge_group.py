# single group Wuv... All the edges fall in the same group... 
# i.e. all the edges have same Wuv... 
# assigning static Wuv value to all the existing edges... Wuv = 0.015 for all the edges... 
# making changes to the function where the Wuv file is read... 
...
docsFileName = "docs_semisyn_sample_gamma_1M.txt"
...
userUserInfluenceFileName = "../mapped_users_influence_restricted_tweets_top_5k_hashes_Gamma_alpha_beta_Wuv_0.01.txt"
userBaseRatesFileName = "../sample-expt-10m-3/calculatedUserBaseRate_FullDay.txt"
userTopicPrefVectorsFileName = "../sample-expt-10m-3/userTopicDistribution.txt"
topicTopicProbVectorsFileName = "../sample-expt-10m-3/topicTopicDistribution_1M.txt"
wordDistTopicsFileName = "../sample-expt-10m-3/topicWordDistribution_1M.txt"
